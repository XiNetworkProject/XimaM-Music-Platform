  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const referralCode = typeof window !== 'undefined'
        ? localStorage.getItem('synaura_referral_code') || undefined
        : undefined;
      ...
      if (response.ok && referralCode) {
        localStorage.removeItem('synaura_referral_code');
      }
        ...
        <div className="w-full max-w-5xl grid gap-8 lg:grid-cols-[minmax(0,1.1fr)_minmax(0,1fr)] items-stretch">
          ...
          >
            ...
            <button
              ...
              className="w-full flex items-center justify-center gap-3 py-2.5 px-4 rounded-xl bg-white/5 border border-white/15 text-sm text-white hover:bg-white/10 transition-all duration-200"
            >
            ...
            <div className="relative my-4">
              ...
              <div className="relative flex justify-center"><span className="px-3 text-[11px] text-white/40 bg-transparent">ou</span></div>
            </div>
