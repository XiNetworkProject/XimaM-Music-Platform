        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">2. Types de cookies utilisés</h2>
              <div className="space-y-4 mb-6">
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    <Settings className="w-5 h-5 text-white/60" />
                    <h3 className="text-sm font-medium text-white">Cookies essentiels</h3>
                  </div>
                ...
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm font-medium text-white">Cookies analytiques</h3>
                  </div>
                  <p className="text-sm text-white/60 mb-2">
                ...
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <div className="flex items-center gap-2 mb-2">
                    ...
                    <h3 className="text-sm font-medium text-white">Cookies de fonctionnalité</h3>
                  </div>
                  <p className="text-sm text-white/60 mb-2">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">3. Cookies tiers</h2>
              <div className="space-y-4 mb-6">
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">3.1 Stripe (Paiements)</h3>
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">4. Durée de conservation</h2>
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Cookies de session</span>
                  <span className="text-sm text-white">Supprimés à la fermeture du navigateur</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Cookies de préférences</span>
                  <span className="text-sm text-white">13 mois maximum</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Cookies analytiques</span>
                  <span className="text-sm text-white">24 mois maximum</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Cookies de sécurité</span>
                  <span className="text-sm text-white">12 mois maximum</span>
                </div>
              </div>

              <h2 className="text-xl font-semibold text-white mb-4 mt-8">5. Gestion des cookies</h2>
              <div className="space-y-4 mb-6">
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">5.1 Paramètres du navigateur</h3>
                  <p className="text-sm text-white/60 mb-2">
                ...
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">5.2 Bannière de consentement</h3>
                  <p className="text-sm text-white/60">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">6. Conséquences du refus</h2>
              <p className="text-sm text-white/60 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">7. Cookies et données personnelles</h2>
              <p className="text-sm text-white/60 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">8. Mise à jour de cette politique</h2>
              <p className="text-sm text-white/60 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">9. Contact</h2>
              <p className="text-sm text-white/60 mb-4">
