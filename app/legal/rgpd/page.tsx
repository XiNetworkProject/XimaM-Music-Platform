        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            <div className="prose prose-invert max-w-none">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">2. Vos droits</h2>
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">3. Comment exercer vos droits</h2>
              <div className="space-y-4 mb-6">
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">3.1 Via votre compte</h3>
                ...
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">3.2 Par email</h3>
                  <p className="text-sm text-white/60">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">4. Délais de réponse</h2>
              <div className="space-y-3 mb-6">
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Droit d'accès</span>
                  <span className="text-sm text-white">1 mois</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Droit de rectification</span>
                  <span className="text-sm text-white">1 mois</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Droit à l'effacement</span>
                  <span className="text-sm text-white">1 mois</span>
                </div>
                <div className="flex justify-between items-center p-3 bg-white/[0.04] rounded-lg">
                  <span className="text-sm text-white/60">Droit à la portabilité</span>
                  <span className="text-sm text-white">1 mois</span>
                </div>
              </div>

              <h2 className="text-xl font-semibold text-white mb-4 mt-8">5. Base légale du traitement</h2>
              <div className="space-y-4 mb-6">
                <div className="p-4 bg-white/[0.04] rounded-lg">
                ...
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">5.2 Exécution du contrat</h3>
                  <p className="text-sm text-white/60">
                    Pour la fourniture des services Synaura (compte, streaming, abonnements).
                  </p>
                </div>
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">5.3 Intérêt légitime</h3>
                  <p className="text-sm text-white/60">
                    Pour l'amélioration des services, la sécurité et la prévention de la fraude.
                  </p>
                </div>
                <div className="p-4 bg-white/[0.04] rounded-lg">
                  <h3 className="text-sm font-medium text-white mb-2">5.4 Obligation légale</h3>
                  <p className="text-sm text-white/60">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">6. Transferts internationaux</h2>
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">7. Sécurité des données</h2>
              <p className="text-sm text-white/60 mb-4">
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">9. Réclamations</h2>
              <p className="text-sm text-white/60 mb-4">
              ...
              <ul className="text-sm text-white/60 space-y-2 mb-6">
                ...
                <li>• Introduire une réclamation auprès de la CNIL :{' '}
                  <a href="https://www.cnil.fr" target="_blank" rel="noopener noreferrer" className="text-white/60 hover:text-white transition-colors">
                    www.cnil.fr
                  </a>
                </li>
              ...
              <h2 className="text-xl font-semibold text-white mb-4 mt-8">10. Contact DPO</h2>
              <div className="p-4 bg-white/[0.04] rounded-lg">
