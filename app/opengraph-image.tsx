...
export default function OpenGraphImage() {
  return new ImageResponse(
    <div style={{ width: '100%', height: '100%', display: 'flex', position: 'relative', alignItems: 'center', justifyContent: 'center', overflow: 'hidden', color: '#F7F6F3', background: '#09090c', fontFamily: 'sans-serif' }}>
      <div style={{ position: 'absolute', width: 760, height: 760, borderRadius: 999, background: 'radial-gradient(circle at 34% 28%, #fff 0 3%, #d96d63 12%, #7357c6 44%, #4a9eaa 70%, transparent 73%)', opacity: 0.78, filter: 'blur(2px)' }} />
