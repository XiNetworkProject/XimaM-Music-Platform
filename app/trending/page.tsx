...
export default function TrendingPage() {
  ...
  return (
    <div className="chambre-legacy-selection min-h-screen bg-[var(--background)] pb-32" data-chambre-music="trending">
      {/* Header avec image de fond */}
      <div className="chambre-selection-hero relative h-64 sm:h-80 bg-gradient-to-b from-orange-900/40 via-red-800/20 to-[var(--background)]">
        ...
        <div className="relative h-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col justify-end pb-6 sm:pb-8">
          ...
          <div className="flex flex-col sm:flex-row items-start sm:items-end gap-4 sm:gap-6">
            ...
            <div className="flex-1 text-white">
              ...
              <h1 className="text-3xl sm:text-5xl lg:text-7xl font-bold mb-2 sm:mb-4 drop-shadow-lg">L’onde<br />collective.</h1>
              <p className="text-sm sm:text-base lg:text-lg text-white/80 mb-2 sm:mb-4 line-clamp-2">Les plus écoutés. Les morceaux qui résonnent sur Synaura en ce moment.</p>
