...
export default function SubscriptionsPage() {
  ...
  return (
    <SynauraAppShell contentClassName="max-w-7xl">
      ...
      <main className="chambre-subscriptions space-y-5 pb-28">
          ...
          <div className="relative grid gap-8 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <motion.div initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35 }}>
              ...
              <h1 className="mt-5 max-w-3xl text-5xl font-black leading-[0.92] tracking-tight text-white sm:text-6xl">
                Ton rythme.<br /><span className="chambre-type-accent">Ton espace.</span>
              </h1>
              <p className="mt-5 max-w-2xl text-base font-semibold leading-7 text-white/62">
                Des crédits, de la place pour publier et les outils créateur. Compare les limites de chaque plan et choisis ce qui te correspond.
              </p>
            ...
            <motion.div initial={{ opacity: 0, y: 18 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.35, delay: 0.08 }} className="chambre-current-plan rounded-[2rem] border border-white/12 bg-white/10 p-4 backdrop-blur">
...
function PlanCard({
  ...
  return (
    <motion.article
      ...
      className={`chambre-plan relative flex h-full flex-col overflow-hidden rounded-[2rem] border p-5 transition hover:-translate-y-1 ${
