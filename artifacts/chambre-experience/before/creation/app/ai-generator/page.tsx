...
function AIGeneratorContent() {
  ...
  return (
    <SynauraAppShell contentClassName="v2-creation v2-ai-workspace chambre-signature-generator flex flex-col overflow-hidden !pb-0 sm:!pb-0">
      <SynauraTopBar
        searchLabel="Rechercher une inspiration, un son ou un createur..."
        secondaryHref="/upload"
        secondaryLabel="Upload"
      ...
      <div className="v2-ai-workspace-body">
        ...
        <section className="v2-ai-toolbar chambre-workspace-toolbar">
          <div className="v2-ai-identity">
            ...
            <p className="chambre-signature-tool-status"><span aria-hidden="true" />{studioStateLabel} <span className="hidden xl:inline">· {studioModeCopy}</span></p>
          </div>
        ...
        >
          ...
          >
            ...
            <div className="space-y-4 p-4">
                ...
                <div className="space-y-3">
                  ...
                  <label className="block">
                    ...
                    <textarea
                      ...
                      placeholder={isInstrumental ? 'Mode instrumental activé' : 'Couplets, refrain, adlibs… ou laisse vide pour une proposition automatique.'}
                ...
                <div className="grid grid-cols-2 gap-2 sm:grid-cols-4">
                  {(['V4_5', 'V4_5PLUS', 'V5', 'V5_5'] as const).map((model) => (
                    <button
                      ...
                      aria-pressed={modelVersion === model}
                      className={`rounded-full px-3 py-2 text-[11px] font-semibold transition ${
                        modelVersion === model ? 'bg-[var(--v2-surface)] text-white' : 'bg-[var(--v2-surface)] text-[var(--v2-muted)] hover:bg-[var(--v2-selected)]'
                      }`}
                    >
                ...
                <div className="mt-3 grid grid-cols-3 gap-2">
                  {([60, 120, 180] as const).map((duration) => (
                    <button
                      ...
                      aria-pressed={generationDuration === duration}
                      className={`rounded-full px-3 py-2 text-[11px] font-semibold transition ${
                        generationDuration === duration ? 'bg-[var(--v2-accent)] text-white' : 'bg-[var(--v2-surface)] text-[var(--v2-muted)] hover:bg-[var(--v2-selected)]'
                      }`}
                    >
                      {duration}s
                    </button>
              ...
              <div className="pt-2">
                <p className="chambre-ai-section-label px-1">Lancer la génération</p>
              </div>

              <div className="chambre-ai-generation-commit rounded-md border border-[var(--v2-line)] bg-[var(--v2-selected)] p-4">
                <p className="text-xs font-semibold leading-5 text-[var(--v2-text)]">
                  {isRemixMode
                    ? 'Une variation IA sera créée à partir de la source ci-dessus.'
                    : 'Deux versions seront générées à partir de ton idée.'}
                </p>
                ...
                >
                  ...
                  {isGenerating
                    ...
                    : rateLimitActive
                      ...
                      : (isRemixMode ? 'Créer une variation' : 'Générer 2 versions')}
                </button>
                <p className="mt-3 text-[11px] leading-5 text-[var(--v2-muted)]">Retrouve ensuite tes versions dans la bibliothèque. Écoute, compare et choisis quoi partager.</p>
              </div>
            </div>
          </aside>
          ...
          <main className="h-full min-h-0 min-w-0 overflow-hidden">
            <section className="v2-ai-results chambre-signature-ai-collection h-full min-h-0 overflow-hidden">
              <LibraryMiddlePanel
                tracks={allTracks}
