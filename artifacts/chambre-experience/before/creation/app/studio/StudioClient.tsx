...
export default function StudioClient() {
  ...
  return (
    <div className="v2-creation v2-studio chambre-signature-studio studio-pro relative h-[100svh] overflow-hidden text-white">
      ...
      <div className="relative z-10 flex flex-col h-full">
                      ...
                      {leftExplorerTab === 'assets' && (
                        <div className="space-y-2">
                          ...
                          {filteredAssets.length === 0 ? (
                            <div className="text-xs text-foreground-tertiary">Aucune source dans ce projet.</div>
                          ) : null}
                        </div>
                      )}
        ...
        {/* Bottom console */}
        <footer className="chambre-signature-studio-console border-t border-[var(--v2-line)] bg-[var(--v2-bg)]">
