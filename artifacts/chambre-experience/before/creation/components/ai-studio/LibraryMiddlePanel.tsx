...
export function LibraryMiddlePanel({
  ...
  return (
    <div className="v2-ai-library-panel flex h-full min-h-0 w-full flex-col bg-[var(--v2-bg)] text-[var(--v2-text)]">
      {/* ── Toolbar ── */}
      <div className="v2-ai-library-toolbar chambre-ai-collection-toolbar shrink-0 space-y-3 border-b border-[var(--v2-line)] px-4 pb-4 pt-5">
        <div className="flex items-center justify-between gap-2 px-0.5">
          <div className="min-w-0">
            <p className="v2-kicker mb-2">02 / Les versions</p>
