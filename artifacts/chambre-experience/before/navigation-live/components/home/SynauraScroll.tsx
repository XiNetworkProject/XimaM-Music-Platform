...
export default function SynauraScroll() {
    ...
    if (item.type === 'track') {
      ...
      return (
        <>
          ...
          <div className="live-track-scene v2-live-track-scene">
          ...
          <div className="live-track-metadata relative z-30 min-w-0">
            <div className="v2-live-track-copy">
              <p className="v2-kicker v2-live-caption">Live / le son prend corps</p>
  ...
  return (
    <div className="v2-live fixed inset-0 z-[100] overflow-hidden text-white" data-chambre-music="live">
      <HomeFlowPrelude
