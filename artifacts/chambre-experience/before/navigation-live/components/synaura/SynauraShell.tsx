...
export function SynauraTopBar({
  ...
  return <header className="v2-topbar">
    ...
    <div className="v2-topbar-row">
      <Link href="/live" className="v2-topbar-brand" aria-label="Synaura, accueil"><SynauraLogo variant="wordmark" size={38} priority decorative /></Link>
...
export function SynauraRouteNav({ className = '', compact = false }: { className?: string; compact?: boolean }) {
  ...
  return <nav className={cx('v2-desktop-nav', className)} aria-label="Navigation Synaura">
