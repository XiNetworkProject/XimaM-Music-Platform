  ...
  return (
    <SynauraAppShell contentClassName="v2-creation v2-clip !max-w-[1440px]">
      <div className="pb-24">
        ...
        <section>
          <header className="v2-clip-header flex items-center gap-4">
            <Film className="h-5 w-5 text-[var(--v2-accent)]" />
            <div className="min-w-0 flex-1">
              <p className="v2-kicker">Créer un Clip</p>
              <h1 className="mt-2">Un son. Ton regard.</h1>
            ...
            <span className="text-xs font-semibold text-[var(--v2-muted)]">{currentStep}/3</span>
          </header>
