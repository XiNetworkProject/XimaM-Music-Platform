...
export default function PublishPage() {
  return (
    <main className="v2-page v2-creation v2-publish">
      <header className="v2-publish-intro">
        <p className="v2-kicker">Publier sur Synaura</p>
        <h1>Ta musique.<br />Son prochain chapitre.</h1>
      ...
      <div>
        <section aria-label="Les étapes de publication">
