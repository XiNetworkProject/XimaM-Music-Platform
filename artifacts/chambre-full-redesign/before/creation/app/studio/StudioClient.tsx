...
export default function StudioClient() {
  ...
  return (
    <div className="v2-creation v2-studio studio-pro relative h-[100svh] overflow-hidden text-white">

      <div className="relative z-10 flex flex-col h-full">
        {/* IDE toolbar shell */}
        <header className="v2-studio-toolbar sticky top-0 z-30">
          <HandoffReturn />
          <div className="h-14 px-3 flex items-center gap-2">
            <div className="flex items-center gap-2">
              <div className="h-9 w-9 rounded-2xl bg-[var(--v2-raised)] border border-border-secondary flex items-center justify-center">
                <Sparkles className="w-4 h-4" />
              </div>
              <div className="leading-tight">
                <div className="v2-kicker">Création</div>
                <h1 className="text-base font-normal">Studio IDE</h1>
              </div>
            ...
            <div className="hidden md:flex items-center gap-1 rounded-xl border border-border-secondary bg-[var(--v2-raised)] p-1">
              <button
                ...
                {shellMode === 'classic' ? (
                  ...
                  <div className="panel-suno v2-studio-workbench h-full min-h-0 flex flex-col overflow-hidden">
                    <div className="p-3 border-b border-border-secondary">
                      ...
                      <div className="mt-2 text-lg font-normal text-foreground-primary">L’intention & les sources</div>
