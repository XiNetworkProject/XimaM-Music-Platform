...
export default function UploadPage() {
  ...
  return (
    <SynauraAppShell contentClassName="v2-creation v2-upload !max-w-[1680px]">
      <SynauraTopBar
      ...
      <header className="v2-upload-header">
        <div className="v2-creative-header">
          <div>
            <p className="v2-kicker">Publication · {releaseLabel}</p>
            <h1>Le prochain son à partager.</h1>
      ...
      <main className="v2-upload-layout">
          ...
          <SynauraPanel className="p-3 sm:p-4">
            ...
            <div className="mt-4">
              ...
              <div className="h-2 overflow-hidden rounded-full bg-[var(--v2-raised)]">
                <div
                  className="h-full rounded-full bg-[var(--v2-surface)] transition-all duration-500"
        ...
        <section className="min-w-0 overflow-hidden rounded-[1.5rem] bg-[var(--v2-surface)] text-white shadow-[0_24px_70px_rgba(20,15,10,0.22)] sm:rounded-[2rem]">
