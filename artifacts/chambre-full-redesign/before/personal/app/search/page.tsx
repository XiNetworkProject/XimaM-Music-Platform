  ...
  return (
    <SynauraAppShell contentClassName="max-w-[1180px]">
      ...
      <div className="space-y-4 pb-28">
        ...
        <form className="v2-search-query" role="search" onSubmit={(event) => { event.preventDefault(); router.push(`/search?q=${encodeURIComponent(queryInput.trim())}`); }}>
