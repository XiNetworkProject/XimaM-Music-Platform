...
function InnerCard({ children, className = '' }: { children: ReactNode; className?: string }) {
  return <div className={`v2-settings-inner border border-[var(--syn-border)] bg-[var(--syn-surface-muted)] p-4 ${className}`}>{children}</div>;
}
        ...
        <div className="v2-settings-layout">
          ...
          <div className="v2-settings-nav">
            <SynauraPanel className="overflow-hidden p-3">
              <div className="v2-settings-nav-profile border-b border-[var(--v2-line)] py-4">
          ...
          {/* CONTENT */}
          <div className="v2-settings-content space-y-4">
            {/* Abonnement */}
