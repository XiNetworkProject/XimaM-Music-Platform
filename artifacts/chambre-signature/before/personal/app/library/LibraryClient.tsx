...
export default function LibraryClient() {
  ...
  const nativeLibraryHeader = (
    <header className="v2-library-header chambre-collection-header">
      <div className="v2-library-title flex flex-wrap items-end justify-between gap-3">
        <div>
          <p className="v2-kicker">Bibliothèque</p>
          <h1 className="mt-3 text-[var(--syn-text-primary)]">Ta musique.<br /><span className="chambre-type-accent">À portée de main.</span></h1>
      ...
      <div className="v2-library-search relative">
    ...
    <SynauraAppShell>
      ...
      <div className={cx(LIBRARY_SCOPE_CLASS, 'space-y-8')}>
        <main className="min-w-0">
          <div className="v2-library-layout text-foreground-primary">
            {nativeLibraryHeader}

            <div className="v2-library-content">
        {/* Playlist detail */}
