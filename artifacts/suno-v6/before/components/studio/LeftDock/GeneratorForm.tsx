      ...
      <div className="panel-suno overflow-hidden">
        <div className="p-4 flex items-center justify-between gap-3">
          ...
          >
            ...
            Générer {normalizeVariantTarget(Number(form.variations || 2))} versions
          </button>
        </div>
        <div className="px-4 pb-4 -mt-2 text-[11px] text-foreground-tertiary">
          Chaque génération produit deux versions A/B, à écouter dès leur disponibilité.
        </div>
      </div>
        ...
        <div className="grid gap-3">
          ...
          <label className="grid gap-1">
            ...
            <span className="text-[10px] text-foreground-tertiary">
              Deux versions correspondent à une génération débitée.
            </span>
          </label>
      ...
      >
        <div className="grid gap-3">
          ...
          <div className="text-[11px] text-foreground-tertiary">
            Les paroles sont requises en mode sur mesure avec voix.
          </div>
        </div>
      </SunoAccordionSection>
