    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          >
            {/* Header */}
            <div className="relative h-64 bg-gradient-to-br from-purple-900 via-pink-900 to-blue-900">
              {/* Image de fond */}
            ...
            <div className="p-6">
              ...
              <div className="flex items-center space-x-4 mb-6">
                <motion.button
                  ...
                  className="flex items-center space-x-3 bg-gradient-to-r from-purple-600 to-pink-600 text-white px-6 py-3 rounded-full font-semibold hover:from-purple-700 hover:to-pink-700 transition-all duration-300"
                >
                ...
                <motion.button
                  ...
                  className={`flex items-center space-x-2 px-4 py-3 rounded-full font-semibold transition-all duration-300 ${
                    track.isLiked
                ...
                <motion.button
                  ...
                  className="flex items-center space-x-2 px-4 py-3 text-gray-400 bg-gray-800 rounded-full font-semibold hover:bg-gray-700 transition-all duration-300"
                >
                  ...
                  <AnimatePresence>
                    {showShareMenu && (
                      <motion.div
                        ...
                        exit={{ opacity: 0, y: 10 }}
                        className="absolute top-full left-0 mt-2 bg-gray-800 rounded-lg shadow-xl border border-gray-700 p-2 z-10"
                      >
                        <button
                          onClick={() => handleShare('copy')}
                          className="flex items-center space-x-2 w-full px-3 py-2 text-gray-300 hover:bg-gray-700 rounded-md transition-colors"
                        >
                          <Copy size={16} />
                ...
                {activeTab === 'info' && (
                  <div className="space-y-6">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      ...
                      {/* Artiste */}
                      <div>
                        <h3 className="text-lg font-semibold text-white mb-3">Artiste</h3>
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            ...
                            <p className="text-gray-400">@{track.artist.username}</p>
                          </div>
                        </div>
                      </div>
                    </div>
