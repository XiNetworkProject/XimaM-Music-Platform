// Les "Clubs" sont des espaces musicaux réels dérivés des catégories existantes de
// forum_posts (feedback / collab / remix / ai_prompt). Aucun système de membres,
// rôles ou salons persistants pour l'instant (voir doc de livraison Clubs V1/V2).
...
export function composeHref(club: ClubConfig): string {
  return `/community/forum/new?category=${club.category}`;
}
