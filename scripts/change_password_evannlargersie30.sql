...
SELECT id, email, username FROM auth.users WHERE email = 'evannlargersie30@gmail.com';
...
SELECT id, email, username, encrypted_password IS NOT NULL as password_updated 
FROM auth.users 
WHERE email = 'evannlargersie30@gmail.com';
