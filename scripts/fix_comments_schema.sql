-- Script de correction pour le schéma des commentaires
-- Supprimer les tables existantes si elles ont des problèmes de types
DROP TABLE IF EXISTS comment_likes CASCADE;
DROP TABLE IF EXISTS comments CASCADE;

-- Recréer la table comments avec les bons types
...
-- Créer la table comment_likes avec les bons types
