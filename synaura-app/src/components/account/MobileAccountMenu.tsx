...
const styles = StyleSheet.create({
  ...
  handle: { alignSelf: 'center', width: 48, height: 5, borderRadius: 99, backgroundColor: colors.textTertiary },
  sheetContent: { gap: 14 },
  ...
  close: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  grid: { gap: 7 },
  item: {
    minHeight: 56,
    flexDirection: 'row',
