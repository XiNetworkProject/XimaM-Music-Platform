...
const styles = StyleSheet.create({
  ticker: { minHeight: 58, overflow: 'hidden', flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 13, borderWidth: 1, borderColor: colors.border, paddingHorizontal: 11, paddingVertical: 9 },
  ...
  countdown: { minHeight: 205, overflow: 'hidden', justifyContent: 'flex-end', gap: 8, borderRadius: 15, borderWidth: 1, borderColor: colors.border, padding: 14 },
  ...
  duelCard: { width: '42%', aspectRatio: 0.88, overflow: 'hidden', borderRadius: 13, borderWidth: 2, borderColor: 'rgba(255,255,255,0.26)', backgroundColor: colors.text },
  ...
  railCard: { width: 270 },
  choice: { gap: 9, borderRadius: 14, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 12 },
  choiceRow: { minHeight: 56, flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 10, backgroundColor: 'rgba(17,17,17,0.04)', paddingHorizontal: 11, paddingVertical: 8 },
