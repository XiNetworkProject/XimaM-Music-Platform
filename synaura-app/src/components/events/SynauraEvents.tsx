...
const styles = StyleSheet.create({
  ...
  countdownCover: { width: 43, height: 43, borderRadius: 4, borderWidth: 2, borderColor: colors.paper },
  ...
  creatorLevel: { minHeight: 98, overflow: 'hidden', flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 4, padding: 12 },
