...
const styles = StyleSheet.create({
  ...
  core: { width: 88, height: 88, overflow: 'hidden', borderRadius: 14, alignItems: 'center', justifyContent: 'center', shadowColor: '#000000', shadowOpacity: 0.32, shadowRadius: 18, shadowOffset: { width: 0, height: 10 }, elevation: 10 },
  coreCompact: { width: 70, height: 70, borderRadius: 12 },
