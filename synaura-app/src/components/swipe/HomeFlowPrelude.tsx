...
const styles = StyleSheet.create({
  ...
  socialTitle: { marginTop: 8, color: '#FFFFFF', fontFamily: FONT_BLACK, fontSize: 15, lineHeight: 18, fontWeight: '900', letterSpacing: -0.35 },
  ...
  trackCardTitle: { color: '#FFFFFF', fontFamily: FONT_BLACK, fontSize: 15, lineHeight: 18, fontWeight: '900', letterSpacing: -0.3 },
  ...
  studioTitle: { marginTop: 9, color: '#FFFFFF', fontFamily: FONT_BLACK, fontSize: 15, lineHeight: 18, fontWeight: '900', letterSpacing: -0.35 },
  ...
  flowTitle: { marginTop: 5, color: '#FFFFFF', fontFamily: FONT_BLACK, fontSize: 31, lineHeight: 30, fontWeight: '900', letterSpacing: -1.55, textShadowColor: 'rgba(0,0,0,0.34)', textShadowRadius: 12, textShadowOffset: { width: 0, height: 5 } },
  flowTitleCompact: { fontSize: 26, lineHeight: 26, letterSpacing: -1.2 },
