...
const styles = StyleSheet.create({
  ...
  closeButton: { width: 36, height: 36, borderRadius: 18, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  content: { paddingHorizontal: 18, gap: 10 },
  card: { borderRadius: 16, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 14 },
  cardTop: { flexDirection: 'row', alignItems: 'center', gap: 11 },
  cover: { width: 54, height: 54, borderRadius: 12, backgroundColor: colors.surfaceMuted },
