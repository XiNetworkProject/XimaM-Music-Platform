...
const styles = StyleSheet.create({
  ...
  drawerLayer: { flex: 1, backgroundColor: 'rgba(0,0,0,0.52)' },
  drawerPeek: { width: '100%' },
  drawerPanel: { flex: 1, overflow: 'hidden', borderTopLeftRadius: 16, borderTopRightRadius: 16, backgroundColor: colors.background, borderTopWidth: 1, borderColor: colors.borderStrong },
  ...
  iconButton: { width: 40, height: 40, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceStrong, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  creditPill: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 10, paddingHorizontal: 11, height: 38, backgroundColor: colors.surfaceStrong, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, borderBottomWidth: 2, borderBottomColor: colors.coral },
  creditText: { color: colors.text, fontSize: 12, fontWeight: '900' },
  studioHeading: { flexDirection: 'row', alignItems: 'flex-end', gap: 14, paddingTop: 4, paddingBottom: 2 },
  studioHeadingCopy: { flex: 1, minWidth: 0 },
  quotaBadge: { minWidth: 54, height: 54, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: '#191621', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(115,87,198,0.42)', borderBottomWidth: 3, borderBottomColor: colors.cyan },
  ...
  simpleComposer: { minHeight: 300, overflow: 'hidden', borderRadius: 14, padding: 18, backgroundColor: '#111015', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(115,87,198,0.36)', borderTopWidth: 3, borderTopColor: colors.violet, shadowColor: colors.violet, shadowOpacity: 0.14, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 5 },
  simpleComposerHead: { flexDirection: 'row', alignItems: 'center', gap: 9 },
  simpleComposerIcon: { width: 32, height: 32, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violet },
  ...
  createCallout: { minHeight: 78, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 12, paddingHorizontal: 12, backgroundColor: '#17141F', borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(217,109,99,0.36)', borderLeftWidth: 4, borderLeftColor: colors.coral },
  createCalloutIcon: { width: 46, height: 46, borderRadius: 23, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violet },
  ...
  sourceBar: { minHeight: 68, flexDirection: 'row', borderRadius: 10, overflow: 'hidden', backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  librarySummary: { minHeight: 60, borderRadius: 10, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 4, backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  summaryCreate: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', marginLeft: 10, backgroundColor: colors.black },
  orbRow: { minHeight: 64, borderRadius: 10, flexDirection: 'row', alignItems: 'center', gap: 11, padding: 11, backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, borderLeftWidth: 3, borderLeftColor: colors.coral },
  ...
  input: { minHeight: 46, borderRadius: 9, paddingHorizontal: 12, color: colors.text, backgroundColor: colors.surfaceStrong, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, fontSize: 13, fontWeight: '700' },
  inputMulti: { minHeight: 88, paddingTop: 12, paddingBottom: 12 },
  inputTall: { minHeight: 150 },
  remixPicker: { minHeight: 66, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12, backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderColor: colors.violet },
  remixName: { marginTop: 4, color: colors.text, fontSize: 12, fontWeight: '900' },
  remixDirection: { borderRadius: 4, padding: 12, gap: 10, backgroundColor: colors.violetSoft, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(115,87,198,0.28)' },
  remixTypeWrap: { flexDirection: 'row', flexWrap: 'wrap', gap: 7 },
  remixTypeChip: { minHeight: 34, borderRadius: 17, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 11, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border },
  ...
  promptVisibility: { flexDirection: 'row', borderRadius: 18, padding: 2, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border },
  promptVisibilityOption: { flex: 1, minHeight: 32, borderRadius: 16, alignItems: 'center', justifyContent: 'center' },
  promptVisibilityOptionActive: { backgroundColor: colors.violet },
  promptVisibilityText: { color: colors.textTertiary, fontSize: 9, fontWeight: '900' },
  promptVisibilityTextActive: { color: colors.paper },
  switchRow: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', borderRadius: 0, paddingVertical: 12, paddingHorizontal: 2, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.border },
  ...
  tag: { minHeight: 32, borderRadius: 16, justifyContent: 'center', paddingHorizontal: 10, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border },
  ...
  choice: { flex: 1, minHeight: 38, borderRadius: 16, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceStrong },
  choiceActive: { backgroundColor: colors.violet },
  ...
  meterStep: { flex: 1, height: 8, borderRadius: 4, backgroundColor: colors.surfaceMuted },
  ...
  inspirationButton: { minHeight: 58, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 11, backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderColor: colors.violet },
  ...
  generateButton: { minHeight: 60, borderRadius: 12, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, backgroundColor: colors.violet, shadowColor: colors.violet, shadowOpacity: 0.28, shadowRadius: 14, shadowOffset: { width: 0, height: 6 }, elevation: 7, borderBottomWidth: 3, borderBottomColor: colors.cyan },
  ...
  lockedSource: { borderRadius: 4, backgroundColor: colors.surface, borderLeftWidth: 3, borderColor: colors.violet, padding: 12, gap: 12 },
  ...
  livePanel: { borderRadius: 4, padding: 14, gap: 9, backgroundColor: colors.black, borderTopWidth: 3, borderColor: colors.violet },
  liveTop: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  liveVisual: { minHeight: 70, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: 4, padding: 10, backgroundColor: 'rgba(247,246,243,0.09)' },
  liveVisualCopy: { flex: 1, minWidth: 0 },
  liveVisualKicker: { color: 'rgba(247,246,243,0.52)', fontSize: 9, fontWeight: '900' },
  liveWaveform: { height: 24, marginTop: 7 },
  liveDot: { width: 7, height: 7, borderRadius: 4, backgroundColor: '#34D399' },
  liveKicker: { flex: 1, color: '#BFB2E7', fontSize: 9, fontWeight: '900' },
  liveStatus: { color: 'rgba(247,246,243,0.52)', fontSize: 9, fontWeight: '900' },
  liveTitle: { color: colors.paper, fontSize: 18, fontWeight: '900' },
  liveTask: { color: 'rgba(247,246,243,0.58)', fontSize: 10, fontWeight: '800' },
  ...
  generationRow: { minHeight: 72, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 11, padding: 11, backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderColor: colors.violet },
  ...
  empty: { alignItems: 'center', borderRadius: 4, padding: 28, backgroundColor: colors.surface, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  authFeature: { minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: 9, borderRadius: 10, backgroundColor: 'rgba(255,255,255,0.08)', paddingHorizontal: 11 },
  ...
  authButton: { marginTop: 13, height: 46, borderRadius: 11, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 22, backgroundColor: colors.violet },
  ...
  inspector: { alignSelf: 'center', width: '100%', maxWidth: 640, maxHeight: '92%', borderTopLeftRadius: 14, borderTopRightRadius: 14, padding: 18, paddingBottom: 24, backgroundColor: colors.surface },
  inspectorHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  inspectorCover: { width: 62, height: 62, borderRadius: 4, overflow: 'hidden', backgroundColor: 'rgba(23,19,19,0.08)' },
  ...
  inspectorClose: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  ...
  inspectorSection: { gap: 8, borderRadius: 4, padding: 11, backgroundColor: colors.surface, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.border },
  ...
  inspectorFolder: { minHeight: 35, borderRadius: 17, flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border },
  ...
  inspectorPrimary: { height: 48, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.violet },
  ...
  inspectorAction: { height: 46, borderRadius: 11, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.surfaceStrong, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border },
  ...
  creditShop: { alignSelf: 'center', width: '100%', maxWidth: 640, maxHeight: '88%', borderTopLeftRadius: 14, borderTopRightRadius: 14, padding: 18, paddingBottom: 28, backgroundColor: colors.surface },
  ...
  pack: { minHeight: 76, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 10, padding: 10, backgroundColor: colors.surface, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  packActive: { backgroundColor: 'rgba(255,111,97,0.09)', borderColor: 'rgba(255,111,97,0.42)' },
  packCheck: { width: 38, height: 38, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  ...
  shopCheckout: { minHeight: 50, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 8, backgroundColor: colors.violet },
