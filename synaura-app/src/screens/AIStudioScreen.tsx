...
const styles = StyleSheet.create({
  ...
  sourceBar: { minHeight: 68, flexDirection: 'row', borderRadius: 14, overflow: 'hidden', backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  librarySummary: { minHeight: 60, borderRadius: 14, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 4, backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  orbRow: { minHeight: 64, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 11, padding: 11, backgroundColor: colors.surface, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, borderLeftWidth: 3, borderLeftColor: colors.coral },
  orb: { width: 42, height: 42, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.coral },
  orbPending: { backgroundColor: colors.violet },
  ...
  input: { minHeight: 46, borderRadius: 12, paddingHorizontal: 12, color: colors.text, backgroundColor: colors.surfaceStrong, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, fontSize: 13, fontWeight: '700' },
  inputMulti: { minHeight: 88, paddingTop: 12, paddingBottom: 12 },
  inputTall: { minHeight: 150 },
  remixPicker: { minHeight: 66, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 12, padding: 12, backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderColor: colors.violet },
  remixName: { marginTop: 4, color: colors.text, fontSize: 12, fontWeight: '900' },
  remixDirection: { borderRadius: 14, padding: 12, gap: 10, backgroundColor: colors.violetSoft, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(115,87,198,0.28)' },
  ...
  inspirationButton: { minHeight: 58, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 11, backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderColor: colors.violet },
  ...
  lockedSourceButton: { height: 40, borderRadius: 12, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, backgroundColor: 'rgba(115,87,198,0.10)' },
  lockedSourceButtonText: { color: colors.violet, fontSize: 12, fontWeight: '900' },
  modelNotice: { minHeight: 46, borderRadius: 14, flexDirection: 'row', alignItems: 'center', gap: 8, paddingHorizontal: 12, backgroundColor: colors.violetSoft, borderWidth: 1, borderColor: 'rgba(115,87,198,0.2)' },
  ...
  livePanel: { borderRadius: 20, padding: 14, gap: 9, backgroundColor: colors.black, borderTopWidth: 3, borderColor: colors.violet },
  liveTop: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  liveVisual: { minHeight: 70, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: 14, padding: 10, backgroundColor: 'rgba(247,246,243,0.09)' },
  ...
  inspector: { alignSelf: 'center', width: '100%', maxWidth: 640, maxHeight: '92%', borderTopLeftRadius: 22, borderTopRightRadius: 22, padding: 18, paddingBottom: 24, backgroundColor: colors.surface },
  inspectorHead: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 12 },
  inspectorCover: { width: 62, height: 62, borderRadius: 8, overflow: 'hidden', backgroundColor: 'rgba(23,19,19,0.08)' },
  ...
  inspectorSection: { gap: 8, paddingVertical: 11, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.border },
  ...
  pack: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 10, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
