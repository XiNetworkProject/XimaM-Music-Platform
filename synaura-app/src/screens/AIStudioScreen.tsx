...
const styles = StyleSheet.create({
  ...
  drawerPanel: { flex: 1, overflow: 'hidden', borderTopLeftRadius: 10, borderTopRightRadius: 10, backgroundColor: colors.background, borderTopWidth: 1, borderColor: colors.borderStrong },
  ...
  creditPill: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 4, paddingHorizontal: 11, height: 36, backgroundColor: colors.surface, borderBottomWidth: 2, borderBottomColor: colors.coral },
  ...
  quotaBadge: { minWidth: 52, height: 52, borderRadius: 4, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.black, borderBottomWidth: 3, borderBottomColor: colors.cyan },
  ...
  modeControl: { flex: 1 },
  modelButton: { height: 42, minWidth: 82, borderRadius: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 11, backgroundColor: colors.surface, borderBottomWidth: 2, borderBottomColor: colors.borderStrong },
  modelButtonText: { color: colors.text, fontSize: 11, fontWeight: '900' },
  simpleComposer: { minHeight: 300, overflow: 'hidden', borderRadius: 4, padding: 18, backgroundColor: colors.black, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  createCallout: { minHeight: 76, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 4, paddingHorizontal: 12, backgroundColor: colors.black, borderLeftWidth: 4, borderLeftColor: colors.coral },
  ...
  sourceBar: { minHeight: 68, flexDirection: 'row', borderRadius: 4, overflow: 'hidden', backgroundColor: colors.surface, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  librarySummary: { minHeight: 58, borderRadius: 0, flexDirection: 'row', alignItems: 'center', paddingHorizontal: 4, backgroundColor: 'transparent', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  orbRow: { minHeight: 64, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 11, padding: 11, backgroundColor: colors.surface, borderLeftWidth: 3, borderLeftColor: colors.coral },
  ...
  input: { minHeight: 44, borderRadius: 4, paddingHorizontal: 12, color: colors.text, backgroundColor: colors.surface, borderBottomWidth: 1, borderColor: colors.borderStrong, fontSize: 13, fontWeight: '700' },
  ...
  generateButton: { minHeight: 60, borderRadius: 4, flexDirection: 'row', alignItems: 'center', gap: 10, paddingHorizontal: 14, backgroundColor: colors.violet, shadowColor: colors.black, shadowOpacity: 0.16, shadowRadius: 13, shadowOffset: { width: 0, height: 6 }, elevation: 7, borderBottomWidth: 3, borderBottomColor: colors.cyan },
  ...
  libraryList: { gap: 10 },
  searchShell: { height: 48, borderRadius: 0, flexDirection: 'row', alignItems: 'center', gap: 9, paddingHorizontal: 2, backgroundColor: 'transparent', borderBottomWidth: 1, borderColor: colors.borderStrong },
  ...
  libraryControl: { flex: 1, minWidth: 0, height: 40, borderRadius: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 6, paddingHorizontal: 9, backgroundColor: colors.surface, borderBottomWidth: 2, borderColor: colors.borderStrong },
  ...
  trackRow: { minHeight: 68, borderRadius: 0, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, backgroundColor: 'transparent', borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.border },
  trackCover: { width: 52, height: 52, borderRadius: 4, overflow: 'hidden', backgroundColor: 'rgba(17,17,17,0.06)' },
  ...
  inspector: { alignSelf: 'center', width: '100%', maxWidth: 640, maxHeight: '92%', borderTopLeftRadius: 10, borderTopRightRadius: 10, padding: 18, paddingBottom: 24, backgroundColor: colors.paper },
  ...
  creditShop: { alignSelf: 'center', width: '100%', maxWidth: 640, maxHeight: '88%', borderTopLeftRadius: 10, borderTopRightRadius: 10, padding: 18, paddingBottom: 28, backgroundColor: colors.paper },
