...
const styles = StyleSheet.create({
  ...
  previewFrame: { overflow: 'hidden', borderRadius: 4, backgroundColor: '#191817', borderWidth: 1, borderColor: 'rgba(247,246,243,0.16)' },
  ...
  editorPanel: { width: '100%', overflow: 'hidden', borderRadius: 4, backgroundColor: 'rgba(31,29,28,0.96)', borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  rowIcon: { width: 48, height: 48, borderRadius: 4, alignItems: 'center', justifyContent: 'center', overflow: 'hidden' },
  ...
  captionInput: { minHeight: 92, borderRadius: 4, paddingHorizontal: 12, paddingVertical: 11, textAlignVertical: 'top' },
  tagInputRow: { minHeight: 48, flexDirection: 'row', alignItems: 'center', gap: 9, borderRadius: 4, paddingHorizontal: 12, backgroundColor: '#272523', borderBottomWidth: 1, borderColor: 'rgba(247,246,243,0.18)' },
  ...
  publishButton: { minHeight: 56, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, borderRadius: 4, backgroundColor: '#363331', borderBottomWidth: 3, borderColor: 'rgba(247,246,243,0.16)' },
  ...
  sheetCover: { width: 52, height: 52, borderRadius: 4, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
