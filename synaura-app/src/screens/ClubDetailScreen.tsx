...
const styles = StyleSheet.create({
  ...
  banner: { borderRadius: 24, padding: 18, marginTop: 6 },
  bannerIcon: { width: 42, height: 42, borderRadius: 15, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,250,242,0.2)' },
  ...
  bannerActionPrimary: { borderRadius: 999, paddingHorizontal: 16, paddingVertical: 11, backgroundColor: '#FFFAF2' },
  ...
  trackCard: { flexDirection: 'row', alignItems: 'center', gap: 9, padding: 8, borderRadius: 13, backgroundColor: 'rgba(17,17,17,0.04)' },
  trackCover: { width: 48, height: 48, borderRadius: 12 },
  trackTitle: { color: '#171313', fontSize: 13, fontWeight: '900' },
  trackArtist: { color: 'rgba(23,19,19,0.46)', fontSize: 11, fontWeight: '700', marginTop: 2 },
  ...
  emptyPosts: { minHeight: 180, alignItems: 'center', justifyContent: 'center', gap: 10, borderRadius: 18, borderWidth: 1, borderStyle: 'dashed', borderColor: 'rgba(23,19,19,0.14)', padding: 20 },
  ...
  submitButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, borderRadius: 999, paddingVertical: 15, marginTop: 8 },
