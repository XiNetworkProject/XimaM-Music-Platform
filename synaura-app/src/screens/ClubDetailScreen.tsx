...
const styles = StyleSheet.create({
  ...
  emptyText: { color: 'rgba(23,19,19,0.52)', fontSize: 12, lineHeight: 18, fontWeight: '700', textAlign: 'center' },
  banner: { borderRadius: 4, padding: 18, marginTop: 6 },
  ...
  bannerActionPrimary: { borderRadius: 4, paddingHorizontal: 16, paddingVertical: 11, backgroundColor: '#FFFAF2' },
  bannerActionPrimaryText: { color: '#171313', fontSize: 12, fontWeight: '900' },
  bannerActionSecondary: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 4, paddingHorizontal: 16, paddingVertical: 11, backgroundColor: 'rgba(255,250,242,0.16)' },
  bannerActionSecondaryText: { color: '#FFFAF2', fontSize: 12, fontWeight: '900' },
  challengeBanner: { marginTop: 12, flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 4, padding: 12, backgroundColor: colors.surface, borderLeftWidth: 3 },
  ...
  postCard: { position: 'relative', backgroundColor: 'transparent', borderRadius: 0, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingVertical: 14, marginBottom: 0, gap: 10 },
  postCardMuted: { backgroundColor: 'rgba(23,19,19,0.02)', borderStyle: 'dashed', opacity: 0.85 },
  trackCard: { flexDirection: 'row', alignItems: 'center', gap: 9, padding: 8, borderRadius: 4, backgroundColor: '#111111' },
  ...
  authorName: { color: '#171313', fontSize: 12, fontWeight: '900' },
  authorMeta: { color: 'rgba(23,19,19,0.45)', fontSize: 10, fontWeight: '700', marginTop: 1 },
  postTitle: { color: colors.text, fontSize: 15, lineHeight: 19, fontWeight: '900' },
  postTitleMuted: { color: 'rgba(23,19,19,0.62)', fontSize: 13, lineHeight: 17, fontWeight: '800' },
  postContent: { color: 'rgba(23,19,19,0.65)', fontSize: 12, lineHeight: 18, fontWeight: '600', marginTop: 4 },
  postContentMuted: { color: 'rgba(23,19,19,0.4)', fontSize: 11, lineHeight: 16, fontWeight: '600', marginTop: 3 },
  postActions: { flexDirection: 'row', alignItems: 'center', gap: 7 },
  postAction: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 10, paddingVertical: 7, borderRadius: 999, backgroundColor: 'rgba(23,19,19,0.045)' },
  postActionLiked: { backgroundColor: 'rgba(217,109,99,0.12)' },
  postActionText: { color: 'rgba(23,19,19,0.7)', fontSize: 10, fontWeight: '900' },
  emptyPosts: { minHeight: 180, alignItems: 'center', justifyContent: 'center', gap: 10, borderRadius: 4, borderWidth: 1, borderStyle: 'dashed', borderColor: 'rgba(23,19,19,0.18)', padding: 20 },
  emptyPostsText: { color: 'rgba(23,19,19,0.5)', fontSize: 12, lineHeight: 18, fontWeight: '700', textAlign: 'center' },
  ...
  input: { minHeight: 52, borderRadius: 4, paddingHorizontal: 15, paddingVertical: 12, backgroundColor: '#FFFAF2', borderBottomWidth: 1, borderColor: 'rgba(23,19,19,0.16)', color: '#171313', fontSize: 14, fontWeight: '700' },
  textarea: { minHeight: 150, textAlignVertical: 'top' },
  trackPickerRow: { gap: 8, paddingRight: 20 },
  trackPicker: { width: 100, padding: 7, borderRadius: 4, borderBottomWidth: 1, borderColor: 'rgba(23,19,19,0.16)', backgroundColor: '#FFFAF2', gap: 6 },
  trackPickerNone: { width: 72, minHeight: 99, borderRadius: 4, borderBottomWidth: 1, borderColor: 'rgba(23,19,19,0.16)', backgroundColor: '#FFFAF2', alignItems: 'center', justifyContent: 'center', gap: 8 },
  ...
  originalPost: { paddingVertical: 15, borderRadius: 0, backgroundColor: 'transparent', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(23,19,19,0.15)' },
  ...
  reply: { flexDirection: 'row', gap: 10, paddingVertical: 12, borderRadius: 0, backgroundColor: 'transparent', borderBottomWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(23,19,19,0.12)' },
  ...
  replyInput: { flex: 1, maxHeight: 110, minHeight: 48, borderRadius: 4, paddingHorizontal: 14, paddingVertical: 12, backgroundColor: '#FFFAF2', borderBottomWidth: 1, borderBottomColor: 'rgba(23,19,19,0.16)', color: '#171313', fontSize: 13, fontWeight: '700' },
