...
const styles = StyleSheet.create({
  ...
  headerContent: { gap: 10, marginBottom: 8 },
  titleRow: { flexDirection: 'row', alignItems: 'center', gap: 12 },
  headerActions: { flexDirection: 'row', gap: 7 },
  kicker: { color: 'rgba(23,19,19,0.46)', fontSize: 10, fontWeight: '900', letterSpacing: 1.8 },
  pageTitle: { color: colors.text, fontSize: 24, lineHeight: 27, fontWeight: '900', marginTop: 2 },
  pageSubtitle: { color: colors.textSecondary, fontSize: 11, lineHeight: 16, fontWeight: '700', marginTop: 3, maxWidth: 260 },
  ...
  heroPanel: { backgroundColor: colors.black, borderRadius: 15, padding: 14, overflow: 'hidden' },
  ...
  heroTitle: { color: colors.paper, fontSize: 19, lineHeight: 22, fontWeight: '900', marginTop: 7, maxWidth: 280 },
  heroText: { color: 'rgba(255,255,255,0.58)', fontSize: 11, lineHeight: 16, fontWeight: '700', marginTop: 7 },
  primaryButton: { alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 7, backgroundColor: colors.paper, borderRadius: 10, paddingHorizontal: 12, paddingVertical: 9, marginTop: 11 },
  ...
  quickComposer: { flexDirection: 'row', alignItems: 'center', gap: 10, backgroundColor: colors.surface, borderRadius: 13, borderWidth: 1, borderColor: colors.border, padding: 10 },
  ...
  intentCard: { width: 156, minHeight: 150, padding: 12, borderRadius: 13, backgroundColor: colors.surface, borderWidth: 1, justifyContent: 'space-between' },
  ...
  stat: { flex: 1, minHeight: 62, borderRightWidth: 1, borderColor: colors.border, padding: 9, justifyContent: 'center' },
  ...
  categoryButton: { flexDirection: 'row', alignItems: 'center', gap: 6, paddingHorizontal: 11, paddingVertical: 8, borderRadius: 11, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  postCard: { position: 'relative', overflow: 'hidden', backgroundColor: colors.surface, borderRadius: 14, borderWidth: 1, borderColor: colors.border, padding: 12, marginBottom: 8 },
  ...
  postTitle: { color: colors.text, fontSize: 16, lineHeight: 20, fontWeight: '900', marginTop: 11 },
  postContent: { color: 'rgba(23,19,19,0.65)', fontSize: 13, lineHeight: 19, fontWeight: '600', marginTop: 7 },
  trackCard: { flexDirection: 'row', alignItems: 'center', gap: 9, marginTop: 11, padding: 8, borderRadius: 10, backgroundColor: 'rgba(17,17,17,0.04)' },
