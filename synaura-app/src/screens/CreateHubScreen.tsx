...
const styles = StyleSheet.create({
  ...
  studioShell: { borderRadius: 20, overflow: 'hidden', borderWidth: 1, borderColor: 'rgba(74,158,170,0.24)', borderBottomWidth: 3, borderBottomColor: colors.cyan },
  studioHero: { minHeight: 246, padding: 18, justifyContent: 'flex-end' },
  ...
  studioOrb: { width: 44, height: 44, borderRadius: 12, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.14)' },
  ...
  studioButton: { marginTop: 14, minHeight: 46, alignSelf: 'flex-start', flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 12, paddingHorizontal: 17, backgroundColor: colors.paper },
  ...
  actionList: { gap: 0 },
  actionRow: { minHeight: 72, flexDirection: 'row', alignItems: 'center', gap: 11, borderRadius: 0, paddingVertical: 10, backgroundColor: 'transparent', borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  actionIcon: { width: 50, height: 50, borderRadius: 12, alignItems: 'center', justifyContent: 'center' },
