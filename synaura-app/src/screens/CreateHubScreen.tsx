...
const styles = StyleSheet.create({
  ...
  studioShell: { borderRadius: 4, overflow: 'hidden', borderBottomWidth: 3, borderBottomColor: colors.cyan },
  ...
  studioOrb: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,255,255,0.14)' },
  ...
  actionIcon: { width: 50, height: 50, borderRadius: 4, alignItems: 'center', justifyContent: 'center' },
