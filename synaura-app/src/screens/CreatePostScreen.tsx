...
const styles = StyleSheet.create({
  ...
  topPublish: { minWidth: 82, height: 42, borderRadius: 11, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violet, paddingHorizontal: 14 },
  topPublishText: { color: colors.paper, fontSize: 12, fontWeight: '900' },
  hero: { borderRadius: 14, padding: 16, backgroundColor: colors.black, borderWidth: 1, borderColor: colors.borderStrong, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  composer: { marginTop: 13, minHeight: 142, borderRadius: 10, padding: 13, textAlignVertical: 'top', color: colors.paper, backgroundColor: 'rgba(255,255,255,0.07)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.16)', fontSize: 14, lineHeight: 20, fontWeight: '700' },
  tools: { flexDirection: 'row', gap: 8 },
  tool: { flex: 1, minHeight: 44, borderRadius: 10, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 7, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  imagePreview: { height: 220, borderRadius: 12, overflow: 'hidden', backgroundColor: colors.surfaceMuted },
  ...
  section: { borderRadius: 12, padding: 12, gap: 8, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  sectionTitle: { color: colors.text, fontSize: 16, fontWeight: '900' },
  track: { minHeight: 64, borderRadius: 9, flexDirection: 'row', alignItems: 'center', gap: 10, padding: 8, backgroundColor: colors.surfaceStrong, borderWidth: 1, borderColor: colors.border },
  trackActive: { backgroundColor: colors.violetSoft, borderLeftWidth: 3, borderLeftColor: colors.violet, paddingLeft: 8 },
  ...
  publish: { marginTop: 16, height: 48, borderRadius: 11, justifyContent: 'center', paddingHorizontal: 20, backgroundColor: colors.violet },
