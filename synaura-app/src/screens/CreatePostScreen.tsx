...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 4, padding: 16, backgroundColor: colors.black, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  composer: { marginTop: 13, minHeight: 142, borderRadius: 4, padding: 13, textAlignVertical: 'top', color: colors.paper, backgroundColor: 'rgba(255,255,255,0.07)', borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.16)', fontSize: 14, lineHeight: 20, fontWeight: '700' },
  tools: { flexDirection: 'row', gap: 8 },
  tool: { flex: 1, minHeight: 44, borderRadius: 4, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 7, backgroundColor: colors.surface, borderBottomWidth: 2, borderColor: colors.borderStrong },
  ...
  imagePreview: { height: 220, borderRadius: 4, overflow: 'hidden', backgroundColor: colors.border },
  ...
  section: { borderRadius: 0, paddingVertical: 12, gap: 0, backgroundColor: 'transparent', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  sectionTitle: { color: colors.text, fontSize: 16, fontWeight: '900' },
  track: { minHeight: 64, borderRadius: 0, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, backgroundColor: 'transparent', borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.border },
