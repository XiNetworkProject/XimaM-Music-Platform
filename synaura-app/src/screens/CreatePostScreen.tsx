...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 16, padding: 15, backgroundColor: colors.black },
  ...
  composer: { marginTop: 13, minHeight: 132, borderRadius: 11, padding: 13, textAlignVertical: 'top', color: colors.paper, backgroundColor: 'rgba(255,255,255,0.08)', fontSize: 14, lineHeight: 20, fontWeight: '700' },
  tools: { flexDirection: 'row', gap: 8 },
  tool: { flex: 1, height: 44, borderRadius: 11, flexDirection: 'row', gap: 7, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  ...
  section: { borderRadius: 14, padding: 12, gap: 9, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
