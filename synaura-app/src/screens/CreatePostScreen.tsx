...
const styles = StyleSheet.create({
  ...
  hero: { borderRadius: 20, padding: 16, backgroundColor: colors.black, borderWidth: 1, borderColor: colors.borderStrong, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  track: { minHeight: 64, flexDirection: 'row', alignItems: 'center', gap: 10, paddingVertical: 8, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
