...
const styles = StyleSheet.create({
  ...
  hint: { color: colors.textTertiary, fontSize: 12, fontWeight: '700' },
  error: { marginTop: spacing.md, color: colors.danger, fontSize: 13, fontWeight: '800' },
  list: { marginTop: spacing.sm, gap: 10 },
  row: { flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: radius.lg, padding: 10, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.border },
  rowPressed: { opacity: 0.7, transform: [{ scale: 0.99 }] },
  cover: { width: 52, height: 52, borderRadius: 15, backgroundColor: 'rgba(17,17,17,0.08)' },
