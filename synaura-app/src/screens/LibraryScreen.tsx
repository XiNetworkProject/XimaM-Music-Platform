...
const styles = StyleSheet.create({
  ...
  playlist: { width: 126, overflow: 'hidden', borderRadius: radius.md, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.border, backgroundColor: colors.surface, paddingBottom: 9 },
  playlistCover: { width: 124, height: 124, overflow: 'hidden', borderTopLeftRadius: radius.md, borderTopRightRadius: radius.md, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  playlistTitle: { marginTop: spacing.sm, marginHorizontal: 9, color: colors.text, fontSize: 11, fontWeight: '900' },
  playlistMeta: { marginTop: 2, marginHorizontal: 9, color: colors.textTertiary, fontSize: 9, fontWeight: '700' },
