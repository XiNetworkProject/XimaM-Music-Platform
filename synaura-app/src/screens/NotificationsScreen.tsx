...
const styles = StyleSheet.create({
  ...
  rowShell: { overflow: 'hidden', borderRadius: 10, backgroundColor: colors.coral },
  rowShellFirst: {},
  rowShellLast: {},
  ...
  rowUnread: { backgroundColor: '#1C1825' },
  ...
  visual: { width: 43, height: 43, borderRadius: 13, alignItems: 'center', justifyContent: 'center' },
