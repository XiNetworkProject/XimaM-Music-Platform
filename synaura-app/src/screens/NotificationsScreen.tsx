...
const styles = StyleSheet.create({
  ...
  list: { paddingTop: 8 },
  loader: { marginTop: 42 },
  sectionTitle: { marginTop: 22, marginBottom: 4, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingBottom: 7, color: colors.textSecondary, fontSize: 11, lineHeight: 14, fontWeight: '900', textTransform: 'uppercase' },
  ...
  row: { minHeight: 88, flexDirection: 'row', alignItems: 'center', gap: 11, backgroundColor: colors.background, paddingHorizontal: 4, paddingVertical: 12 },
  ...
  visual: { width: 43, height: 43, borderRadius: 22, alignItems: 'center', justifyContent: 'center' },
