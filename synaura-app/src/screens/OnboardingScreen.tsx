...
const styles = StyleSheet.create({
  ...
  primaryButton: { width: '100%', minHeight: 54, marginTop: 22, borderRadius: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, paddingHorizontal: 16, backgroundColor: colors.violet },
