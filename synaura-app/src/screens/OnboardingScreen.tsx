...
const styles = StyleSheet.create({
  ...
  progressTrack: { height: 4, marginTop: 8, overflow: 'hidden', borderRadius: 2, backgroundColor: 'rgba(17,17,17,0.1)' },
  progressFill: { height: '100%', borderRadius: 2, backgroundColor: colors.violet },
  step: { marginTop: 18 },
  introStage: { overflow: 'hidden', borderRadius: 8, backgroundColor: colors.black },
  ...
  primaryButton: { width: '100%', minHeight: 54, marginTop: 22, borderRadius: 8, flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: 9, paddingHorizontal: 16, backgroundColor: colors.black },
  ...
  summaryHero: { minHeight: 92, flexDirection: 'row', alignItems: 'center', gap: 13, borderRadius: 8, padding: 14, backgroundColor: colors.black },
