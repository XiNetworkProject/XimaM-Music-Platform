...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 8, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: 'rgba(17,17,17,0.075)', padding: 14 },
  ...
  image: { width: '100%', aspectRatio: 4 / 3, borderRadius: 8, marginTop: 14, backgroundColor: '#E7DDD4' },
  ...
  commentPreview: { marginTop: 14, flexDirection: 'row', alignItems: 'center', gap: 10, borderRadius: 10, backgroundColor: 'rgba(115,87,198,0.08)', padding: 12 },
