...
const styles = StyleSheet.create({
  ...
  card: { borderRadius: 14, backgroundColor: '#FFFFFF', borderWidth: 1, borderColor: 'rgba(17,17,17,0.075)', padding: 14 },
  ...
  image: { width: '100%', height: 250, borderRadius: 12, marginTop: 14, backgroundColor: '#E7DDD4' },
