...
const styles = StyleSheet.create({
  ...
  overviewHero: { minHeight: 84, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 12, borderWidth: StyleSheet.hairlineWidth, borderColor: 'rgba(115,87,198,0.42)', backgroundColor: '#17141F', padding: 12, shadowColor: colors.violet, shadowOpacity: 0.15, shadowRadius: 12, shadowOffset: { width: 0, height: 5 }, elevation: 4 },
  ...
  settingsMenu: { overflow: 'hidden', borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, borderRadius: 10, backgroundColor: colors.surface },
  ...
  section: { borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, borderRadius: 10, backgroundColor: colors.surface, padding: 16 },
