...
const styles = StyleSheet.create({
  ...
  overviewHero: { minHeight: 82, flexDirection: 'row', alignItems: 'center', gap: 12, borderRadius: 4, backgroundColor: colors.black, padding: 12 },
  ...
  dashboardShortcut: { minHeight: 66, flexBasis: 210, flexGrow: 1, flexDirection: 'row', alignItems: 'center', gap: 9, borderTopWidth: 2, borderTopColor: colors.cyan, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.borderStrong, paddingHorizontal: 4 },
  ...
  settingsMenu: { overflow: 'hidden', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  settingsIcon: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violetSoft },
  ...
  section: { borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingVertical: 16 },
  ...
  input: { minHeight: 44, borderRadius: 4, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, backgroundColor: colors.backgroundAlt, paddingHorizontal: 12, color: colors.text, fontSize: 14, fontWeight: '700' },
