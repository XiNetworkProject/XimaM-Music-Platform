...
const styles = StyleSheet.create({
  ...
  authIcon: { width: 58, height: 58, borderRadius: radius.lg, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violetSoft },
  ...
  primaryAction: { minWidth: 160, height: 46, marginTop: 18, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: colors.text },
  ...
  scoreHero: { overflow: 'hidden', borderRadius: radius.lg, padding: 16, ...shadows.floating },
  scoreTop: { flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', gap: 10 },
  scoreBadge: { flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.1)', paddingHorizontal: 10, paddingVertical: 7 },
  ...
  metricCard: { minHeight: 132, overflow: 'hidden', borderRadius: radius.lg, padding: 13, ...shadows.soft },
  metricIcon: { width: 35, height: 35, alignItems: 'center', justifyContent: 'center', borderRadius: radius.md, backgroundColor: 'rgba(255,255,255,0.15)' },
  ...
  summaryCard: { minHeight: 112, borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 13 },
  ...
  qualityPanel: { minHeight: 76, flexDirection: 'row', alignItems: 'flex-start', gap: 10, borderRadius: radius.lg, borderWidth: 1, padding: 13 },
  ...
  panel: { borderRadius: radius.lg, borderWidth: 1, borderColor: colors.border, backgroundColor: colors.surface, padding: 14, ...shadows.soft },
  ...
  chartFrame: { overflow: 'hidden', borderRadius: radius.md, backgroundColor: '#FAF9F7' },
  ...
  rankingCover: { width: 45, height: 45, overflow: 'hidden', borderRadius: radius.md, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  ...
  postImage: { width: 44, height: 44, borderRadius: radius.md, backgroundColor: colors.surfaceMuted },
  ...
  actionButtonPrimary: { backgroundColor: colors.text },
