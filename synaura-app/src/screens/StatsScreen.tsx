...
const styles = StyleSheet.create({
  ...
  scoreHero: { overflow: 'hidden', borderRadius: radius.sm, padding: 16, ...shadows.floating },
  ...
  metricCard: { minHeight: 132, overflow: 'hidden', borderRadius: radius.sm, padding: 13, ...shadows.soft },
  ...
  summaryCard: { minHeight: 112, borderTopWidth: 2, borderTopColor: colors.cyan, borderBottomWidth: StyleSheet.hairlineWidth, borderBottomColor: colors.borderStrong, paddingVertical: 13 },
  ...
  panel: { borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingVertical: 16 },
  ...
  chartFrame: { overflow: 'hidden', borderRadius: radius.sm, backgroundColor: '#FAF9F7' },
