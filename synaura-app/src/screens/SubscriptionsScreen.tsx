...
const styles = StyleSheet.create({
  ...
  iconButton: { width: 42, height: 42, borderRadius: 21, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceMuted },
  hero: { overflow: 'hidden', borderRadius: 14, padding: 16, gap: 12, backgroundColor: colors.black, borderWidth: 1, borderColor: colors.borderStrong, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  currentPlan: { minHeight: 62, borderRadius: 4, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 11, backgroundColor: 'rgba(255,255,255,0.08)', borderBottomWidth: 1, borderBottomColor: 'rgba(255,255,255,0.18)' },
  ...
  unlockPanel: { borderRadius: 0, paddingVertical: 12, backgroundColor: 'transparent', borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  ...
  unlockCard: { width: 150, minHeight: 124, borderRadius: 4, padding: 12, backgroundColor: colors.surface },
  unlockIcon: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.violet },
  ...
  usagePanel: { borderRadius: 4, padding: 13, gap: 12, backgroundColor: colors.surface, borderLeftWidth: 3, borderColor: colors.coral },
  ...
  usageTrack: { height: 7, borderRadius: 4, overflow: 'hidden', backgroundColor: colors.surfaceMuted },
  usageFill: { height: 7, borderRadius: 4, backgroundColor: colors.coral },
  periodSwitch: { flexDirection: 'row', borderRadius: 0, padding: 0, backgroundColor: 'transparent', borderBottomWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong },
  periodButton: { flex: 1, minHeight: 44, borderRadius: 0, alignItems: 'center', justifyContent: 'center' },
  ...
  planList: { gap: 12 },
  planCard: { borderRadius: 14, padding: 14, gap: 12, backgroundColor: colors.surface, borderWidth: 1, borderColor: colors.borderStrong },
  ...
  planButtonTextDark: { color: colors.black },
