...
const styles = StyleSheet.create({
  ...
  hero: { overflow: 'hidden', borderRadius: 4, padding: 16, gap: 12, backgroundColor: colors.black, borderTopWidth: 3, borderTopColor: colors.violet },
  ...
  planList: { gap: 12 },
  planCard: { borderRadius: 4, padding: 14, gap: 12, backgroundColor: colors.surface, borderTopWidth: 1, borderBottomWidth: 1, borderColor: colors.borderStrong },
