...
const styles = StyleSheet.create({
  ...
  iconButton: { width: 44, height: 44, borderRadius: 22, alignItems: 'center', justifyContent: 'center', backgroundColor: 'rgba(255,250,242,0.88)', borderWidth: 1, borderColor: colors.border },
  hero: { overflow: 'hidden', borderRadius: 27, padding: 18, gap: 14, backgroundColor: colors.black },
  ...
  heroTitle: { maxWidth: 280, color: colors.paper, fontSize: 31, lineHeight: 33, fontWeight: '900' },
  heroText: { color: 'rgba(255,250,242,0.58)', fontSize: 11, lineHeight: 17, fontWeight: '700' },
  currentPlan: { minHeight: 66, borderRadius: 19, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 12, backgroundColor: 'rgba(255,250,242,0.08)' },
  ...
  periodSwitch: { flexDirection: 'row', borderRadius: 22, padding: 4, backgroundColor: 'rgba(255,250,242,0.82)', borderWidth: 1, borderColor: colors.border },
  periodButton: { flex: 1, minHeight: 43, borderRadius: 18, alignItems: 'center', justifyContent: 'center' },
  ...
  planList: { gap: 12 },
  planCard: { borderRadius: 25, padding: 15, gap: 13, backgroundColor: 'rgba(255,250,242,0.9)', borderWidth: 1, borderColor: colors.border },
  ...
  planButton: { minHeight: 49, borderRadius: 23, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.black },
  ...
  compare: { borderRadius: 22, padding: 14, gap: 0, backgroundColor: 'rgba(255,250,242,0.86)', borderWidth: 1, borderColor: colors.border },
  ...
  faq: { borderRadius: 22, padding: 14, gap: 5, backgroundColor: 'rgba(255,250,242,0.86)', borderWidth: 1, borderColor: colors.border },
