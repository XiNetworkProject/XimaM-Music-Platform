...
const styles = StyleSheet.create({
  ...
  currentPlan: { minHeight: 62, borderRadius: 14, flexDirection: 'row', alignItems: 'center', justifyContent: 'space-between', padding: 11, backgroundColor: 'rgba(255,255,255,0.08)', borderWidth: 1, borderColor: 'rgba(255,255,255,0.14)' },
  ...
  unlockCard: { width: 150, minHeight: 124, borderRadius: 14, padding: 12, backgroundColor: colors.surface },
  ...
  usagePanel: { borderRadius: 14, padding: 13, gap: 12, backgroundColor: colors.surface, borderLeftWidth: 3, borderColor: colors.coral },
