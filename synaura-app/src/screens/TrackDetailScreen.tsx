...
const styles = StyleSheet.create({
  ...
  trackPostAction: { minHeight: 32, flexDirection: 'row', alignItems: 'center', gap: 5, borderRadius: 16, backgroundColor: colors.surfaceMuted, paddingHorizontal: spacing.sm },
  trackPostActionActive: { backgroundColor: colors.violet },
