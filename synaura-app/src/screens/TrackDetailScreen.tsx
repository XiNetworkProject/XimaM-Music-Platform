...
const styles = StyleSheet.create({
  ...
  hero: { minHeight: 410, marginHorizontal: spacing.lg, overflow: 'hidden', borderRadius: radius.md, justifyContent: 'flex-end', padding: spacing.lg, backgroundColor: colors.black },
  ...
  artist: { marginTop: spacing.xs, color: 'rgba(255,255,255,0.72)', fontSize: 14, fontWeight: '800' },
  ...
  stats: { marginHorizontal: spacing.lg, flexDirection: 'row', borderWidth: 0, borderTopWidth: StyleSheet.hairlineWidth, borderBottomWidth: StyleSheet.hairlineWidth, borderRadius: 0, backgroundColor: 'transparent' },
  stat: { flex: 1, alignItems: 'flex-start', paddingVertical: spacing.md },
  ...
  clipsButton: { height: 40, justifyContent: 'center', borderRadius: 20, paddingHorizontal: spacing.md, backgroundColor: colors.black },
  challengeIcon: { width: 38, height: 38, borderRadius: 19, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.black },
  ...
  chip: { overflow: 'hidden', borderRadius: radius.sm, borderWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingHorizontal: spacing.md, paddingVertical: spacing.sm, color: colors.textSecondary, fontSize: 10, fontWeight: '800' },
  ...
  postsButton: { minHeight: 38, flexDirection: 'row', alignItems: 'center', gap: 6, borderRadius: 19, backgroundColor: colors.black, paddingHorizontal: spacing.md },
  postsButtonText: { color: colors.paper, fontSize: 11, fontWeight: '900' },
  trackPosts: { paddingHorizontal: spacing.lg, marginTop: spacing.sm },
  ...
  trackPostCard: { borderTopWidth: StyleSheet.hairlineWidth, borderColor: colors.borderStrong, paddingVertical: spacing.md },
  ...
  trackPostAction: { minHeight: 32, flexDirection: 'row', alignItems: 'center', gap: 5, borderRadius: 16, backgroundColor: 'rgba(17,17,17,0.055)', paddingHorizontal: spacing.sm },
